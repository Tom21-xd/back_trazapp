...
export const PERMISSIONS = [
  ...
  // Actividades
  {
    key: 'activity:read:own',
    group: 'Actividades',
    description: 'Ver mis actividades asignadas',
  },
  {
    key: 'activity:read:any',
    group: 'Actividades',
    description: 'Ver todas las actividades',
  },
  {
    key: 'activity:create',
    group: 'Actividades',
  ...
  },
  {
    key: 'activity:assign',
    group: 'Actividades',
    description: 'Asignar/desasignar usuarios',
  },
  // Etapas
  ...
  // Tipos de proyecto
  {
    key: 'projectType:create',
    group: 'Tipos de proyecto',
    description: 'Crear tipos de proyecto',
  },
  {
    key: 'projectType:update',
    group: 'Tipos de proyecto',
    description: 'Editar tipos de proyecto',
  },
  {
    key: 'projectType:delete',
    group: 'Tipos de proyecto',
    description: 'Eliminar tipos de proyecto',
  },
  // Usuarios
  {
    key: 'user:read',
  ...
  // Comentarios
  {
    key: 'comment:create',
    group: 'Comentarios',
    description: 'Comentar en actividades',
  },
  {
    key: 'comment:update:own',
    group: 'Comentarios',
    description: 'Editar mis comentarios',
  },
  {
    key: 'comment:delete:own',
    group: 'Comentarios',
    description: 'Eliminar mis comentarios',
  },
  {
    key: 'comment:update:any',
    group: 'Comentarios',
    description: 'Editar comentarios de otros',
  },
  {
    key: 'comment:delete:any',
    group: 'Comentarios',
    description: 'Eliminar comentarios de otros',
  },
  // Archivos
  {
    key: 'file:upload',
  ...
  },
  {
    key: 'file:delete:own',
    group: 'Archivos',
    description: 'Eliminar mis archivos',
  },
  {
    key: 'file:delete:any',
    group: 'Archivos',
    description: 'Eliminar archivos de otros',
  },
  {
    key: 'file:read:any',
    group: 'Archivos',
    description: 'Ver/descargar archivos de cualquier actividad',
  },
  // Solicitudes de cambio de etapa
  {
    key: 'stagechange:read:own',
    group: 'Solicitudes',
    description: 'Ver mis solicitudes de cambio',
  },
  {
    key: 'stagechange:read:any',
    group: 'Solicitudes',
    description: 'Ver todas las solicitudes (cola pendientes)',
  },
  {
    key: 'stagechange:create',
    group: 'Solicitudes',
    description: 'Solicitar cambio de etapa',
  },
  {
    key: 'stagechange:comment',
    group: 'Solicitudes',
    description: 'Comentar en solicitudes',
  },
  {
    key: 'stagechange:review',
    group: 'Solicitudes',
    description: 'Aprobar/rechazar solicitudes',
  },
  {
    key: 'stagechange:manage:any',
    group: 'Solicitudes',
    description:
      'Gestionar solicitudes de cualquier actividad (no solo asignadas)',
  },
  // Auditoría
  {
    key: 'audit:read',
